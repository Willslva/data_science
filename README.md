...
* Uma revendedora de automóveis de luxo com sede em São Paulo. A empresa começou sua operação no Brasil em 2016 e atua nos quatro estados da região sudeste, mais os estados do Paraná e Bahia. O analista de dados deve construir um Dashboard que represente os dados de vendas no período de 2016 a 2019. 
* Seu gerente precisa das seguintes informações:
* 1-Total de Vendaspor Ano
* 2-Custo de Entrega do Veículo Por Fabricante
* 3-Custo de Mão de Obra Por Estado
* 4-Total de Vendas Geral e Matriz de Vendas
* Além disso, o CEO da empresa deve visualizar o total de vendas por estado e  se  as  vendas  estão  acima  ou  abaixo  da média. 
